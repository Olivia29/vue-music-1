                ...
                <div class="bottom">
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-bar-wrapper">
                            <progress-bar @percentChange="onPropgressBarChange" :percent='percent' ></progress-bar>
                        </div>
  ...
  export default {
    ...
    methods: {
        ...
        middleTouchMove(e){
            ...
            console.log(width)
            this.$refs.lyricList.$el.style[transform] = `tanslate3d(${width}px,0 0)`; 
        },
        middleTouchEnd(e){
